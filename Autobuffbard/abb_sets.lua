...
bff_sets.Aminon = {'Blade Madrigal', 'Honor March', 'Sword Madrigal', 'Valor Minuet V', 'Valor Minuet IV'}

bff_sets.ph = {"Adventurer's Dirge","Warding Round","Puppet's Operetta","Goddess's Hymnus","Shining Fantasia"}
--T2
bff_sets.Procne = {"Valor Minuet IV",'Honor March',"Knight's Minne IV", 'Valor Minuet V', "Blade Madrigal",}
-- Procne BRD: Minx dirge HM DD, Schrezo Sirvantee Ballad once tank Dispel
bff_sets.Procne2 = {"Adventurer's Dirge",'Honor March',"Sentinel's Scherzo", 'Valor Minuet V', "Blade Madrigal",}
bff_sets.Aristaeus = {"Victory March",'Honor March',"Valor Minuet IV", 'Valor Minuet V', "Knight's Minne IV",}
--Henwen BRD: SV Minuet x2, March, Honor March, Dirge (on DD), Sirvente (on Tank)
bff_sets.Henwen = {"Adventurer's Dirge",'Honor March',"Valor Minuet IV", 'Valor Minuet V', "Victory March",}
--Gigelorum BRD: SV Minuet x2, March, Honor March, Dirge (on DD), Sirvente (on Tank)
bff_sets.Gigelorum = {"Adventurer's Dirge",'Honor March',"Valor Minuet IV", 'Valor Minuet V', "Victory March",}
